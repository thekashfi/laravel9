...
Route::post('contact-us', [ContractController::class, 'store'])->name('connect-us-save');
...
Route::group(['as' => 'admin.', 'prefix' => 'admin', 'middleware' => 'admin'], function() {
    ...
    Route::get('contact-us', [ContractController::class, 'index'])->name('connect-us-list');
    Route::get('contact-us/{id}/delete', [ContractController::class, 'destroy'])->name('connect-us-delete');
});
