<div class="relative inline-block text-left">
    ...
    <div class="origin-top-right absolute mt-2 w-40 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5" style="display: none;
    width: 150px !important;" id="filter-dropdown">
